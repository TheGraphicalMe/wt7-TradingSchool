          ...
          <div className="order-2 md:order-1 flex flex-col gap-4 md:pt-8">
            ...
            <div className="flex flex-col gap-2 mt-1 mb-4">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="group flex items-center justify-center gap-3 w-full bg-[#9B6DFF] hover:bg-[#854ff7] active:bg-[#7236ec] text-white font-cond font-bold text-lg md:text-xl uppercase tracking-wider py-3.5 md:py-4 px-6 rounded-xl shadow-[0_4px_25px_rgba(155,109,255,0.45)] hover:shadow-[0_6px_35px_rgba(155,109,255,0.7)] transition-all duration-200 transform hover:-translate-y-0.5"
              >
                <span>Enroll Now & Secure Your Seat</span>
                <span className="transform transition-transform duration-200 group-hover:translate-x-1.5 text-xl font-body">→</span>
              </a>
            </div>
        ...
        <div className="max-w-4xl mx-auto mt-32 relative">
          ...
          <div className="mt-24 text-center">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group inline-flex items-center justify-center gap-3 bg-[#9B6DFF] hover:bg-[#854ff7] active:bg-[#7236ec] text-white font-cond font-bold text-xl md:text-2xl uppercase tracking-wider px-12 py-5 rounded-2xl shadow-[0_4px_30px_rgba(155,109,255,0.5)] hover:shadow-[0_6px_45px_rgba(155,109,255,0.8)] transition-all duration-200 transform hover:-translate-y-1"
            >
              <span>Enroll Now & Secure Your Seat</span>
